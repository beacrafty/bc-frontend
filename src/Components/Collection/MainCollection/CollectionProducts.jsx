  ...
  return (
    <>
      {(!infiniteScroll && fetchStatus != "idle") || isLoading ? (
        ...
        <NoDataFound customClass="no-data-added " title="NoProductFound" description="Please check if you have misspelt something or try searching with other way." height="345" width="345" imageUrl={`public/assets/svg/empty-items.svg`} />
      )}
      {!infiniteScroll ? (
